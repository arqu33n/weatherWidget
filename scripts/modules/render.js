  ...
  widget.insertAdjacentHTML(
    ...
    ` <div class="widget__today">
      <div class="widget__date-block">
        <p class="widget__date">${currentDateTime.dayOfMonth} ${
      currentDateTime.month
    } ${currentDateTime.year}</p>
        <p class="widget__time">${currentDateTime.hours}:${
  ...
  widget.insertAdjacentHTML(
    ...
    `  <div class="widget__other">
      ...
      <div class="widget__pressure">
        ...
        <p class="widget__pressure-value">${data.main.pressure.toFixed(1)}</p>
